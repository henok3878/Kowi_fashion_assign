...
import 'package:kowi_fashion/ui/screens/recipe/recipe_viewmodel.dart';
...
class RecipeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    RecipeViewModel controller = Get.put(RecipeViewModel());
    return OrientationBuilder(builder: (context, orientation){
        ...
        switch(orientation){
          ...
          case Orientation.landscape:
            return  CustomYoutubePlayer(videoPlayer: "nPt8bK2gbaU",);
    }
